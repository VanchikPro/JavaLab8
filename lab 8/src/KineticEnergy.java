public class KineticEnergy extends PhysicalObject implements Comparable<KineticEnergy>, Measurable, Sample<KineticEnergy>{
    ...
    public KineticEnergy createSample() {
        return new KineticEnergy(this.id, this.mass, this.speed); // реализация метода Sample
    }
}
